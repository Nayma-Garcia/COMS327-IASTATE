...
//THIS WAS JUST TO TEST THE NCURSES AND MAKE SURE I HAD PUT IT IN THE RIGHT PLACE IN THE MAKEFILE, DELETE THIS BEFORE YOU TURN IT IN
  	// initscr(); //starts the ncurses
